export default ({ IDL }) => {
  ...
  return IDL.Service({
    'add_ii_anchor_number' : IDL.Func(
        [IDL.Text, DeviceType, IDL.Text],
        [IDL.Vec(IDL.Text)],
        [],
      ),
    'add_new_device' : IDL.Func(
        [DeviceDataExternal, IDL.Text, DeviceType],
        [DeviceAddResponse],
        [],
      ),
    'get_delegation' : IDL.Func(
        [IDL.Text, DeviceType, IDL.Text, SessionKey, Timestamp],
    ...
    'get_profile_by_name' : IDL.Func(
        [IDL.Text],
        [IDL.Opt(Profile), IDL.Vec(Profile), IDL.Vec(IPProfile)],
        ['query'],
      ),
    'prepare_delegation' : IDL.Func(
        [IDL.Text, DeviceType, IDL.Text, SessionKey, IDL.Opt(IDL.Nat64)],
        [UserKey, Timestamp],
        [],
      ),
    ...
    'unbind_device' : IDL.Func(
        [IDL.Text, IDL.Text, DeviceType],
        [DeviceRemoveResponse],
        [],
      ),
    'update_nns_wallets' : IDL.Func(
        [IDL.Text, DeviceType, IDL.Text, AccountDetails],
